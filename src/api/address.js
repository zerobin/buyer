...
export function apiAddressDelete(params) {
  return request({
    url: `/c/auth/address/delete`,
    needToken: true,
    method: Method.POST,
    params,
  });
...
export function apiAddressSave(data) {
  return request({
    url: `/c/auth/address/save`,
    needToken: true,
    method: Method.POST,
...
export function apiAddressUpdate(data) {
  return request({
    url: `/c/auth/address/update`,
    needToken: true,
    method: Method.POST,
    headers: { "Content-Type": "application/json" },
    data,
