<template>
  <div class="navbar" :class="{ 'small-search-box': useClass == 'fixed-show' }">
    <div class="container width_1450_auto flex flex-a-c">
      ...
      <!-- 登录，购物车 -->
      <div class="head-main-right fr size14">
        <Dropdown
          trigger="click"
        ...
        >
          <span class="sign-in">
            <Avatar v-if="userInfo.avatar" :src="userInfo.avatar" size="30" />
          ...
          <template #list>
            <DropdownMenu>
              ...
              <DropdownItem @click.native="goto('/home/MyAddress')"
                >My Address</DropdownItem
              >
              <DropdownItem @click.native="signOut">Sign out</DropdownItem>
            </DropdownMenu>
          </template>
        </Dropdown>
        <span class="sign-in" @click="login" v-else>
        ...
        <Dropdown placement="bottom-end" trigger="click">
          ...
          <DropdownMenu slot="list">
            <div
              class="shopping-cart-null"
              style="width: 340px"
              v-show="getCartList.length <= 0"
            >
              <p style="padding: 10px 20px; text-align: left">
                Shopping cart is empty ! Go shopping !~
              </p>
            </div>
            <div class="shopping-cart-list" v-show="getCartList.length > 0">
                  ...
                  <div class="common-header-cart-card">
                    ...
                    <div class="cart-words fl">
                      <div class="cart-list-item-a line-hidden2">
                        ...
                        <p
                          class="hover-pointer goods-title ellipsis"
                          v-if="item.skuDesc"
                        >
                      ...
                      <div class="clearfix type-price margin-t20">
                        ...
                        <span class="icon-cursor" @click.stop="deleteCart(item)"
...
export default {
  ...
  computed: {
    ...
    ...mapGetters(["getCartList", "cartNum", "priceTotal"]),
    // 购物车商品数量
