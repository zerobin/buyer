      ...
      <div class="cart-goods">
            ...
            <div class="goods-item">
              <div class="width_60">
                <Checkbox
                  ...
                  @on-change="changeChecked(goods.checked, 'goods', goods.id)"
                ></Checkbox>
              </div>
              <div
              ...
              <div class="width_200">
                <Button
                  ...
                  >Edit</Button
                >
                <Button size="small" type="primary" @click="delGoods(goods.id)"
                  >Delete</Button
                >
              </div>
            </div>
        ...
        <div class="cart-goods-footer">
          <div>
            ...
            <div class="handle-btn" @click="delGoods()">Delete</div>
  ...
  methods: {
    ...
    async changeChecked(status, type, id) {
      if (type === "all") {
        ...
        // 单个商品
        this.cartList.filter((item) => item.id === id)[0].checked = status;
        if (status) {
          this.checkedNum++;
        } else {
          this.checkedNum--;
