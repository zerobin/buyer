      ...
      <div class="inner_wrap">
        ...
        <div class="LogLayout boder-box clearfix">
          ...
          <div class="fl right_zone">
            <div class="title size20 bold">SIGN IN</div>
            <p class="size14 reg_tip">
              Need a ELEK Shop Account?
              <a class="theme_color" @click="$router.push('signUp')">Sign Up</a>
            </p>
            <div>
              <Form
                ref="formInline"
              ...
              >
                ...
                <div
                  class="margin-tb20 clearfix"
                  @click="$router.push('forgetPassword')"
                >
                  <a rel="nofollow" class="size14 fr link" data-v-126fae51=""
                    >Forgot Password?
                  </a>
                </div>
                <FormItem>
...
export default {
  ...
  methods: {
    ...
    login() {
      apiLogin.login(this.formData).then((res) => {
        if (res.code === 200) {
          ...
          window.localStorage.setItem("account", res.data.email);
    ...
    loginSuccess(accessToken) {
      ...
      storage.setItem("accessToken", "Bearer" + " " + accessToken);
    },
  },
  mounted() {
    this.formData.email = window.localStorage.getItem("account") || "";
  },
  watch: {
    type(v) {
      if (v) {
