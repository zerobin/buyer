      ...
      <div class="add-info-box">
        ...
        <div class="car-btn-group">
          ...
          <div class="car-btn-row">
            <router-link
              :to="`/goodsDetail?skuId=${detail.id}&goodsId=${detail.goodsId}`"
            >
              <button class="btn-car hover-pointer btn-car-to-detail">
                查看商品详情
              </button>
            </router-link>
            <router-link to="/cart">
              <button class="btn-car hover-pointer btn-car-to-pay">
                去购物车结算>
              </button>
            </router-link>
          </div>
