  ...
  <div class="wrapper">
    ...
    <div class="wrapper-head">
      ...
      <div class="head-right">
        <div>
          应付金额 <span class="price">{{ payDetail.price | unitPrice }}</span
          >元
        </div>
      </div>
    </div>
    <div class="wrapper-box">
      ...
      <div
        v-if="
          support.includes('WALLET') && $route.query.orderType !== 'RECHARGE'
        "
        class="-box-item"
        @click="handlePay('WALLET')"
      >
