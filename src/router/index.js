...
const EmailValidator = (resolve) =>
  require(["@/pages/EmailValidator"], resolve);
const PrivatePolicy = (resolve) => require(["@/pages/PrivatePolicy"], resolve);
const ForgetPassword = (resolve) =>
  require(["@/pages/ForgetPassword"], resolve);
const GoodsList = (resolve) => require(["@/pages/GoodsList"], resolve);
const GoodsFilter = (resolve) => require(["@/pages/GoodsFilter"], resolve);
...
const agreement = (resolve) => require(["@/pages/agreement/index"], resolve);
const articleDetail = (resolve) => require(["@/pages/article/detail"], resolve);
const Wholesale = (resolve) => require(["@/pages/Wholesale"], resolve);
const BestSellers = (resolve) => require(["@/pages/BestSellers"], resolve);
const NewArrivals = (resolve) => require(["@/pages/NewArrivals"], resolve);
const LoyaltyStore = (resolve) => require(["@/pages/LoyaltyStore"], resolve);
